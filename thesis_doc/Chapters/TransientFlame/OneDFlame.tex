...
\begin{figure}
	...
	\caption{Forced pressure field examples, $f \in \{100, \; 150, \; 200\}$ kHz.}
\end{figure}
...
\begin{figure}
	...
	\end{minipage}
	\caption{Flame progression for data collection period $\timeVar \in [75, \; 575] \; \mu$s.}
\end{figure}