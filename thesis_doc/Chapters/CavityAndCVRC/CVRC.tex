...
We now turn to the pre-processing stage of developing hyper-reduced PROMs for this case. Although a brief overview was given in Section~\ref{sec:cavity}, we give more attention here to some of the nuances related to load balancing and MPI communications for parallel computations.
