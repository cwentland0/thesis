...
\begin{enumerate}
    ...
    \item A collected analysis of several important steps in developing effective PROMs for large-scale multi-scale chaotic problems combustors (e.g. residual weighting, limiters, centering/scaling, etc.).
