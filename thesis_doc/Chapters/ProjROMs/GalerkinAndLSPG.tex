...
For a linear representation, the test basis is simply $\testBasisCons = \consScale \consTrial$. In the specific case of $\consScale = \resScale = \identMat$, recalling that $\consTrial$ is orthonormal, this simplifies the ODE greatly to
%
\begin{equation}
