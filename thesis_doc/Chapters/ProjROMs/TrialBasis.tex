...
Moving forward, the general representation of the approximate state given by Eq.~\ref{eq:consSolApproxGen} is retained in deriving PROMs in Sections~\ref{sec:classicROMs}--\ref{sec:adaptation}. Where appropriate, simplifications are provided for the case of a linear trial space.
