...
\begin{frame}{\small{Model-form preserving least-squares with variable transformation (MP-LSVT)\footnotemark[5]}}
	...
	\begin{minipage}{0.49\linewidth}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[5]{\tiny{Huang et al., \textit{J Comp Phys.}, Vol. 448, 2022, pp. 110742.}}
\end{frame}
...
\begin{frame}{Least-squares regression \& interpolation}
    \begin{itemize}
		...
		\end{equation*}
	\end{itemize}
	\footnotetext[6]{\tiny{Everson and Sirovich, \textit{J Opt Soc Am A}, Vol. 12 (8), 1995, pp 1657--1664.}}
	\footnotetext[7]{\tiny{Chaturantabut and Sorensen, \textit{SIAM J Sci Comput}, Vol. 32 (5), 2010, pp. 2737--2764.}}
\end{frame}
...
\begin{frame}{Sampling algorithms}
    \begin{itemize}
		...
		\begin{itemize}
			\item DEIM\footnotemark[7], GNAT\footnotemark[3]
			\item Accelerated MPE\footnotemark[8], GPOD+E\footnotemark[9]
			\item Determinant-based\footnotemark[10]
		\end{itemize}
	\end{itemize}
	...
	\end{minipage}
	\vspace{-2em}
	\footnotetext[8]{\miniscule{Zimmermann and Willcox, \textit{SIAM J Sci Comp}, Vol. 38, 2016, pp. 2827--2850.}}
	\footnotetext[9]{\miniscule{Peherstorfer et al., \textit{SIAM J Comp Sci}, Vol. 42, 2020, pp. 2837--2864.}}
	\footnotetext[10]{\miniscule{Saito et al., \textit{IEEE Access}, Vol. 9, pp. 68535--68551}}
\end{frame}
...
\begin{frame}{Numerical Experiments}
	...
	\end{equation*}
	\normalsize
	\footnotetext[11]{\tiny{Li et al., \textit{3rd Int Conf CFD}, 2006, pp. 619--624.}}
\end{frame}
...
\begin{frame}{Unsteady field predictions}
	\begin{figure}
		\begin{minipage}{0.49\linewidth}
			\animategraphics[autoplay,loop,trim=1em 1em 1em 1em,width=0.99\linewidth,every=5]{10}{/experiments/2d_cavity/fom_zoom/fig_Static_Pressure_zoom_}{15005}{15250}
		\end{minipage}
		\begin{minipage}{0.49\linewidth}
				\animategraphics[autoplay,loop,trim=1em 1em 1em 1em,width=0.99\linewidth,every=5]{10}{experiments/2d_cavity/rom_zoom/fig_Static_Pressure_zoom_}{15005}{15250}
		\end{minipage}
		\caption*{T = 8 ms, $\numPrimModes =$152}
	\end{figure}
\end{frame}
...
\begin{frame}{3D ``box'' combustor\footnotemark[12]}
	...
	\begin{minipage}{0.49\linewidth}
		\begin{figure}
			\animategraphics[every=2,autoplay,loop,trim=0.25em 0.25em 0.25em 0.25em,width=0.95\linewidth]{10}{experiments/box/fom_iso_animation/fig_}{000002}{000100}
		\end{figure}
	\end{minipage}
	\begin{minipage}{0.49\linewidth}
		\begin{figure}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[12]{\tiny{Wentland et al., \textit{AIAA SciTech}, 2021.}}
\end{frame}
...
\begin{frame}{Unsteady field predictions}
	...
	\begin{minipage}{0.84\linewidth}
		\begin{figure}
			\animategraphics[every=2,autoplay,loop,width=0.99\linewidth]{10}{experiments/box/hprom_temp_slice_animation/fig_merged_}{2}{100}
		\end{figure}
	\end{minipage}
\end{frame}

% \begin{frame}{3D truncated CVRC\footnotemark[12]}
%     \begin{itemize}
% 		\item Truncated single-element gaseous methane-peroxide combustor
% 		\item Flamelet-progress variable combustion model (GRI-Mech 1.2)
...
% 		\end{figure}
% 	\end{minipage}
% 	\footnotetext[12]{\tiny{Yu et al., \textit{J Propul Power}, Vol. 28 (5), 2012, pp. 876--887}}
% \end{frame}
...
\begin{frame}{Misc: The Adjoint Petrov--Galerkin method\footnotemark[13]}
	...
	\begin{minipage}{0.49\linewidth}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[13]{\tiny{Parish et al., \textit{Comput Method Appl M}, Vol. 365, 2020, pp. 112991.}}
\end{frame}
...
\begin{frame}{\footnotesize{Misc: Prototyping Environment for Reacting Flow Order Reduction Methods (PERFORM)\footnotemark[14]}}
	...
	\footnotetext[14]{\tiny{Wentland, \textit{J Open Source Soft.}, Under review.}}
\end{frame}
...
\begin{frame}{Misc: Non-linear manifold ROMs\footnotemark[15]}
	...
	\begin{minipage}{0.49\linewidth}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[15]{\tiny{Wentland et al., \textit{74th APS DFD}, Vol. 66 (17), 2021.}}
\end{frame}
...
\begin{frame}{Misc: HPROM toolchain (contrib. to PDP)}
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\footnotetext[16]{\tiny{Arnold-Medabalimi, \textit{SoftwareX}, In preparation.}}
\end{frame}
...
\begin{frame}{Future: 3D nine-element combustor\footnotemark[17]}
	...
	\begin{minipage}{0.53\linewidth}
		...
		\vspace{-3em}
	\end{minipage}
	\footnotetext[17]{\tiny{Harvazinski et al., \textit{AIAA SciTech}, 2019}}
\end{frame}
