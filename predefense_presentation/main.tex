...
\begin{frame}{Least-squares Petrov--Galerkin (LSPG)\footnotemark[2]}
	...
	\end{tcolorbox}
	\footnotetext[2]{\tiny{Carlberg el al., \textit{Int. J. Numer. Meth. Engng}, Vol. 86, 2010, pp. 155--181.}}
\end{frame}
...
\begin{frame}{State of the art in 2017}
	...
	\footnotetext[4]{\tiny{Carlberg et al., \textit{J Comp Phys}, Vol. 242, 2013, pp. 623--647.}}
...
\begin{frame}{\small{Model-form preserving least-squares with variable transformation (MP-LSVT)\footnotemark[6]}}
	...
	\begin{minipage}{0.49\linewidth}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[6]{\tiny{Huang, Wentland, and Duraisamy, \textit{J Comp Phys.}, Vol. 448, 2022, pp. 110742.}}
\end{frame}
...
\begin{frame}{Least-squares regression \& interpolation}
	...
	\footnotetext[8]{\tiny{Chaturantabut and Sorensen, \textit{SIAM J Sci Comput}, Vol. 32 (5), 2010, pp. 2737--2764.}}
\end{frame}
...
\begin{frame}{Sampling algorithms}
    \begin{itemize}
		...
		\begin{itemize}
			\item DEIM\footnotemark[8], GNAT\footnotemark[4]
			\item Accelerated MPE\footnotemark[9], GPOD+E\footnotemark[10]
			\item Determinant-based\footnotemark[11]
		\end{itemize}
	\end{itemize}
	...
	\end{minipage}
	\vspace{-2em}
	\footnotetext[9]{\miniscule{Zimmermann and Willcox, \textit{SIAM J Sci Comp}, Vol. 38, 2016, pp. 2827--2850.}}
	\footnotetext[10]{\miniscule{Peherstorfer et al., \textit{SIAM J Comp Sci}, Vol. 42, 2020, pp. 2837--2864.}}
	\footnotetext[11]{\miniscule{Saito et al., \textit{IEEE Access}, Vol. 9, pp. 68535--68551}}
\end{frame}
...
\begin{frame}{Offline pre- and post-processing scalability}
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\footnotetext[12]{\tiny{Arnold-Medabalimi, \textit{SoftwareX}, In preparation.}}
\end{frame}
...
\begin{frame}{Full-order model}
	...
	\end{equation*}
	\normalsize
	\footnotetext[13]{\tiny{Li et al., \textit{3rd Int Conf CFD}, 2006, pp. 619--624.}}
\end{frame}
...
\begin{frame}{3D ``box'' combustor\footnotemark[14]}
	...
	\begin{minipage}{0.49\linewidth}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[14]{\tiny{Wentland, Huang, and Duraisamy, \textit{AIAA SciTech}, 2021.}}
\end{frame}
...
\begin{frame}{Computational savings}
    \begin{figure}
		\animategraphics[controls={step},buttonsize=1.0em,width=0.6\linewidth]{10}{experiments/box/pareto/samplingTypeStudy_Average_errorRaw_time_calcAndMPI_pareto_labels_}{1}{3}
	\end{figure}
	\begin{tcolorbox}[colframe=blue!50!white,halign=center]
...
\begin{frame}{\footnotesize{Prototyping Environment for Reacting Flow Order Reduction Methods (PERFORM)\footnotemark[15]}}
	...
	\footnotetext[15]{\tiny{Wentland, \textit{J Open Source Soft.}, Under review.}}
\end{frame}
...
\begin{frame}{Non-linear manifold ROMs\footnotemark[16]}
	...
	\begin{minipage}{0.49\linewidth}
		...
		\end{figure}
	\end{minipage}
	\footnotetext[16]{\tiny{Wentland, Huang, and Duraisamy, \textit{74th APS DFD}, Vol. 66 (17), 2021.}}
\end{frame}
...
\begin{frame}{Future: scalable basis and sampling adaptation}
	...
	\end{itemize}
	\footnotetext[18]{\tiny{Peherstorfer, \textit{SIAM J Sci Comp}, Vol. 42 (5), 2020, pp. A2803--A2836}}
\end{frame}
